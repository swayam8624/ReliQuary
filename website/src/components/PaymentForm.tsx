...
// Handles Stripe payment processing with card elements
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex space-x-3 pt-4">
                <button
                  type="button"
                  onClick={onCancel}
                  className="flex-1 px-4 py-3 text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                >
                  Cancel
                </button>
                <button
